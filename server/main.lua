...
RegisterNetEvent('pz_lspd:plainte')
AddEventHandler('pz_lspd:plainte', function(msg)
	local _src = source
	sendToDiscordWithSpecialURL("Plaintes en ligne","**Plainte reçue de: __"..GetPlayerName(_src).."__**:\n\n"..msg, 16744192, Config.PlaintesWebhook)
end)

RegisterNetEvent('pz_lspd:rdv')
AddEventHandler('pz_lspd:rdv', function(msg)
	local _src = source
	...
	sendToDiscordWithSpecialURL("Demande de rendez-vous","Demande de rendez-vous émise par: __"..firstname.." "..lastname.. "__. Tél: **__"..phone.."__**", 2061822, Config.RdvWebhook)
end)
